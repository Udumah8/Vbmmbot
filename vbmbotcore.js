...
class VBMMBot {
    constructor() {
        ...
        this.isEmergencyStopped = false; // Renamed to avoid conflict with method
        this.tradeQueue = [];
        this.metrics = {
            tradesExecuted: 0,
            volumeTraded: 0,
...
async emergencyShutdown() {
    ...
    try {
        if (this.connection) {
            // Solana Web3.js Connection doesn't have a close method, but we can clear event listeners
            console.log('🛑 Closing RPC connection...');
            this.connection.removeAllListeners();
        }
        if (this.jupiter) {
            // Jupiter client uses axios, no explicit close needed, but clear reference
        ...
        // Delay exit to allow async tasks to complete
